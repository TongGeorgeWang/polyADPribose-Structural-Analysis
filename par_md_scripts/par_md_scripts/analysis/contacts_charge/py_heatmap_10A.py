...
cbar.set_label(r'Charge within 10 $\mathrm{\AA}$ (e)', fontsize=20, labelpad=9)  # Increase colorbar label font size
...
plt.savefig('15mer_100mM_NaCl_cluster10A_heatmap_charge.pdf', dpi=300,bbox_inches = "tight")
